...
@Component({
  template: `<div class="money-tooltip-container"
            [ngStyle]="styles"
            [ngClass]="position"
          #tooltipContainer>
...
export class MoneyTooltipComponent {
  constructor(@Inject('tooltipConfig') public config) {}
  public styles = {};
    ...
    switch (this.position) {
      case 'top':
        return {
          ...
          'left.px': this.calcLeft(
            clientRectInject.right,
            clientRectInject.width,
            width
          )
        };
    }
